...
import { selectVendorCategory } from "./actions"
...
export default function VendorCategorySelection() {
  ...
  const handleCategorySelect = async (category: string) => {
    ...
    try {
      ...
      const result = await selectVendorCategory(formData)
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-green-100 py-8 px-4">
      <div className="max-w-6xl w-full">
        <div className="flex items-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800">What would you like to sell?</h1>
        </div>
